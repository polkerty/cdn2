    ...
    function b() {
        d(), e(document).ready(function(a) {
            function b() {
				...
				if ( exercise == "Exercise.com Referral" ) {
					exercise = "https://exercise.com/business";
				}
				...
				a(nameel).html('<style>#widgetForm .return_answer {display:block !important; padding-bottom:30px !important; }.widgetTitle img { max-width:100% !important; }#like_in_calc { display:none  !important;}#widgetForm input.backButton {bottom:85px !important;}a.exurl {padding: 8px 13px 8px 13px !important;font-size: 16px !important;float: right !important;color: #ffffff   !important;background-image: -moz-linear-gradient(top, #d7782c  , #b86114  )  !important;background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #d7782c  ), color-stop(1, #b86114  ))  !important;background-image: -ms-linear-gradient(top, #d7782c  , #b86114  )  !important;filter: progid: DXImageTransform.Microsoft.Gradient(startColorStr="#d7782c  ", endColorStr="#b86114  ", GradientType=0 ) !important;border-radius: 5px !important;-moz-border-radius: 5px !important;-webkit-border-radius: 5px !important;border: 1px solid #a95e16   !important;-webkit-text-shadow: 1px 1px 3px #4d4d4d   !important;-moz-text-shadow: 1px 1px 3px #4d4d4d   !important;-o-text-shadow: 1px 1px 3px #4d4d4d   !important;-ms-text-shadow: 1px 1px 3px #4d4d4d   !important;text-shadow: 1px 1px 3px #4d4d4d   !important;-webkit-box-shadow: 0 0 5px -1px #343434   !important;-moz-box-shadow: 0 0 5px -1px #343434   !important;box-shadow: 0 0 5px -1px #343434   !important;font-weight: normal !important;margin-left:auto !important;bottom:40px !important;margin-right:auto !important;display:block !important;clear:both !important;position:absolute !important;left:0% !important;min-width:99% !important;padding-left:0px !important;padding-right:0px !important;text-align:center !important;}.answer_area {overflow-y: visible !important;}a.custreferral {display: inline-block !important;bottom: 0 !important;position: absolute !important;width: 100% !important;text-align: center !important;left: 0 !important;padding-top: 5px !important;padding-bottom: 5px !important;}</style>');
